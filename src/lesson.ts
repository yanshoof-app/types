...
export function isStudyGroup(obj: unknown): obj is IStudyGroup {
  return typeof obj === 'object' && obj !== null && 'subject' in obj && 'teacher' in obj;
}
 ...
 */
export interface IStudyGroupWithModification extends IStudyGroup, IModification {}
...
export function isILessonObj(obj: unknown): obj is ILesson {
  return typeof obj === 'object' && obj !== null && 'subject' in obj && 'teacher' in obj && 'class' in obj;
}
